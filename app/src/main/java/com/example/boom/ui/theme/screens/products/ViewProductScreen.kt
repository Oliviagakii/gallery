package com.example.boom.ui.theme.screens.products
...
import com.example.boom.data.ProductViewModel
...
fun ViewProductsScreen(navController: NavHostController) {
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        val emptyProductState = remember { mutableStateOf(Products.Product("", "", "", "", "", "")) }
        var emptyProductsListState = remember { mutableStateListOf<Products.Product>() }
