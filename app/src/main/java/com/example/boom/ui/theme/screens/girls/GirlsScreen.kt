package com.example.boom.ui.theme.screens.girls
...
@Composable
fun GirlsScreen(navController: NavController){
    Column(
        modifier = Modifier
            .fillMaxSize()
    ...
    )
    {
        ...
        Image(
            painter = painterResource(id = R.drawable.girlcover3) ,
...
fun GirlsScreenPreview(){
    GirlsScreen(rememberNavController())
}
