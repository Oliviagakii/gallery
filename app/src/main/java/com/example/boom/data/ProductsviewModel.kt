...
class ProductViewModel(var navController: NavController, var context: Context) {
        ...
        storageRef.putFile(filePath).addOnCompleteListener{
            ...
            if (it.isSuccessful){
                ...
                storageRef.downloadUrl.addOnSuccessListener {
                    ...
                    var product =
                        Products.Product(name, quantity, price, phone, imageUrl, productId)
    ...
    fun allProducts(
        product: MutableState<Products.Product>,
        products: SnapshotStateList<Products.Product>):SnapshotStateList<Products.Product>{
        progress.show()
        ...
        ref.addValueEventListener(object: ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (snap in snapshot.children){
                    var retrievedProduct = snap.getValue(Products.Product::class.java)
